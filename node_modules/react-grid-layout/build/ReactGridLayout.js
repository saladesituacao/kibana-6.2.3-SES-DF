...
var ReactGridLayout = function (_React$Component) {
  ...
  ReactGridLayout.prototype.processGridItem = function processGridItem(child) {
    console.log("ReactGridLayout.prototype.processGridItem ");
    
    
    if (!child.key) return;
    var l = (0, _utils.getLayoutItem)(this.state.layout, String(child.key));
    if (!l) return null;
    if(parseInt(document.all?document.body.clientWidth:window.innerWidth,10) < 992 && child._owner.memoizedProps.panels[child.key].notShowInMobile != undefined && child._owner.memoizedProps.panels[child.key].notShowInMobile == true){
		return;
	}
    /*
    console.info("l")
  ...
  ReactGridLayout.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.Children.map(this.props.children, function (child) {
        var c = _this2.processGridItem(child);
        //tentar colocar a propriedade aqui em griditem
