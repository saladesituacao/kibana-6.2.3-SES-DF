...
pasta kibana/node_modules/react-grid-layout/build/GridItem.js
...
find . -type f -name "*.*" -print0 | xargs -0 sed -i '' -e 's/Export:/Exportar:/g'
find . -type f -name "*.js" -print0 | xargs -0 sed -i '' -e "s/: 'Descending'/: 'Descendente'/g"
find . -type f -name "*.js" -print0 | xargs -0 sed -i '' -e "s/: 'Ascending'/: 'Ascendente'/g"

# Plugins movidos da pasta src/core_plugins para plugins
...
| platform |  |
| --- | --- |
| OSX | [tar](https://snapshots.elastic.co/downloads/kibana/kibana-6.2.3-SNAPSHOT-darwin-x86_64.tar.gz) |
| Linux | [tar](https://snapshots.elastic.co/downloads/kibana/kibana-6.2.3-SNAPSHOT-linux-x86_64.tar.gz) [deb](https://snapshots.elastic.co/downloads/kibana/kibana-6.2.3-SNAPSHOT-amd64.deb) [rpm](https://snapshots.elastic.co/downloads/kibana/kibana-6.2.3-SNAPSHOT-x86_64.rpm) |
| Windows | [zip](https://snapshots.elastic.co/downloads/kibana/kibana-6.2.3-SNAPSHOT-windows-x86_64.zip) |
