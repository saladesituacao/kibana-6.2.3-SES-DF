  ...
  function syncViewControls() {
    ...
    if (!setToInterval) {
      ...
      if (_.get(timeAgg, ['params', 'interval', 'val']) !== 'custom') {
        ...
        setToInterval.display = 'Customizado: ' + _.get(timeAgg, ['params', 'interval', 'val']);
      } else {
        setToInterval.val = 'custom';
        setToInterval.customInterval = _.get(timeAgg, ['params', 'customInterval']);
        setToInterval.display = 'Customizado: ' + _.get(timeAgg, ['params', 'customInterval']);
      }
          ...
          xaxis: {
            ...
            tickFormatter: function (v, axis) {
              ...
              if (tickGap < 86400) {
                ...
                return moment(v).format('D MMM YYYY');
              }
            },
